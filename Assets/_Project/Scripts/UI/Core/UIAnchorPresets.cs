...
namespace BES.UI
{
    public static class UIAnchorPresets
    {
        ...
        public static void ApplyMainMenuServerHit(RectTransform rect) => BottomCenter(rect, new Vector2(220, 52), new Vector2(0, 320));
        ...
        public static void ApplyMainMenuNewGameHit(RectTransform rect) => ApplyMainMenuServerHit(rect);
        public static void ApplyMainMenuContinueHit(RectTransform rect) => BottomCenter(rect, new Vector2(220, 36), new Vector2(0, 380));
